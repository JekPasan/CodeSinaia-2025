...
<<<<<<< HEAD
    ...
    def test_num_vir(self):
        self.assertEqual(roman_converter(4.4), None)
...
class TestHundreds(unittest.TestCase):
    ...
    def test_250(self):
        self.assertEqual(roman_converter(250), "CCL")
    
    def test_499(self):
        self.assertEqual(roman_converter(499), "CDXCIX")
    
class TestFiveHundreds(unittest.TestCase):
    def test_base_500(self):
        self.assertEqual(roman_converter(500), "D")
    
    def test_750(self):
        self.assertEqual(roman_converter(750), "DCCL")
